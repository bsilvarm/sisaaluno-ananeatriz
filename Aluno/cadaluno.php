...
<h2 style="margin-left: 500px; color:black; margin-left: 525px;">Cadastro de Aluno</h2> 
  <form method="GET" action="crudaluno.php" style="height: 450px; width: 800px; background-color: #aeabe7; border-radius: 15px; margin-left: 200px; margin-top: 20px; padding-top: px;display: flex; justify-content: center; align-items:center; flex-direction: column">
   
 
    <label for="">Nome</label> <br>
     <input type="text" name="nome" style= "width: 700px; height: 30px; border-radius: 20px; border-color: transparent;"> <br>

     <label for="">Idade</label><br>
     <input type="text" name="idade" style= "width: 700px; height: 30px; border-radius: 20px; border-color: transparent;"> <br>
     <label for="">id</label> <br>
     <input type="text" name="id" style= "width: 700px; height: 30px; border-radius: 20px; border-color: transparent;"> <br>
